...
class SearchForm(Form):
    ...
    param3 = DateField('Pick a Date', validators=[DataRequired()], id='Date')
    ...
    check = RadioField('Select type of OUTPUT', validators=[DataRequired()],
                       choices=[('JSON', 'JSON'), ('Classic', 'Classic Web Response')],default='Classic')
...
def index():
    ...
    if search_form.validate_on_submit():
        return redirect(url_for('results', param1=str(search_form.param1.data), param2=str(search_form.param2.data),
                                param3=search_form.param3.data.strftime('%d-%m-%Y'),
